              ...
              <form class="form-horizontal " method="post">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input disabled id="posted_by" name="posted_by" value="{{ old('posted_by') ?? Auth::user()->name }}" type="text" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Genre / Category</label>
                    <div class="col-sm-10">
                      ...
                      <!-- <input id="genre" name="genre" value="{{ old('genre') ?? $post->genre  }}" type="text" class="form-control"> -->
                    </div>
                  </div>
                  <div class="form-group">
